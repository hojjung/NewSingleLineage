...
#include "MeshMergeLib.generated.h"

USTRUCT(BlueprintType)
struct MYJRPG_API FSkelMeshMergeSectionMapping_BP
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MYJRPG_API FSkelMeshMergeUVTransform
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MYJRPG_API FSkelMeshMergeUVTransformMapping
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MYJRPG_API FSkeletalMeshMergeParams
{
	GENERATED_BODY()
...
*/
UCLASS()
class MYJRPG_API UMeshMergeLib : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
